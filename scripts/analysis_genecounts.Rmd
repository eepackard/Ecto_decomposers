...
```{r}
taxsetlist.agar[[1]][which(taxsetlist.agar[[1]]$`Cluster ID` %in% wae.15$...1),]

print(taxsetlist.agar[[1]][which(taxsetlist.agar[[1]]$`Cluster ID` %in% wae.15$ID),c(1,4,9)],n=150)

wae.15$refernce_names<-cbind(taxsetlist.agar[[1]][which(taxsetlist.agar[[1]]$`Cluster ID` %in% wae.15$...1),]$Reference)
...
Cortinarius.spec<-c("C.archeri","C.saniosus","Cortinarius sp1","C.austrovenetus","C.aff.campbellae","P.glaucopus") #Cortinariaceae
Cortinarius.counts<-c(8,4,5,8,13,9) #Miyauchi 9 in glaucopus (12)
...
Lactarius.spec<-c("L.controversus",	"L.subdulcis","L.indigo","L.hengduanensis","L.hatsudake","L.sanguifluus","L.deliciosus","L.vividus","L.akahatsu","L.pseudohatsudake","L.psammicola","L.quietus")
Lactarius.counts<-c(9,1,3,3,3,3,3,3,3,3,3,1) 
...
Russula.spec<-c("Russula sp1","Russula sp2","R.emetica1","Russula sp3","R.earlei","R.emetica2","R.seminuda","R.ochroleuca","R.vinacea","R.compacta","R.rugulosa","R.brevipes","R.dissimulans")
Russula.counts<-c(2,1,2,6,1,2,2,2,2,1,2,2,1)
