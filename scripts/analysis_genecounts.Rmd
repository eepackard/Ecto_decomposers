...
Hymenogastraceae.taxa<-c("Hebeloma brunneifolium","Hebeloma cylindrosporum","Gymnopilus junonius","Gymnopilus chrysopellus")
Hymenogastraceae.counts<-c(3,3,15,20)
...
Strophariaceae.taxa<-c("Pholiota alnicola","Pholiota conissans","Pholiota molesta","Pholiota sp.","Stropharia rugosoannulata","Hypholoma sublateritium","Galerina marginata","Agrocybe pediades","Agrocybe Praecox","Psilocybe cubensis", "Psilocybe serbica","Psilocybe subaeruguinosa","Leratiomyces ceres","Leratiomyces erythrocephalus")
Strophariaceae.counts<-c(14,11,14,14,18,5,22,12,14,9,6,6,27,15)
...
family.average<-family.average[c(3,7,3,14,14,7,8,14,3,8,4,6,14,10,4,5,2,14,12,3,4,11,12,2,13,9),]
family.average$Genus<-c("Tylospora","Luellia","Amphinema","Pseudotomentella","Tomentellopsis","Trechispora","Hygrophorus",
"Tomentella","Athelia","Ampulloclitocybe","Tylopilus","Entocybe","Hydnellum","Inocybe","Leccinum","Craterellus","Amylocorticiellum","Thelephoraceae","Xylodon","Byssoporia","Imleria","Xeromphalina","Hyphodontia","Ceraceomyces","Deconica","Naucoria")
```
...
Gene.counts[nrow(Gene.counts)+1,1]<-"Squamanita" #no squamanticea 
Gene.counts[nrow(Gene.counts)+1,1]<-"Cystoderma" # no squamanticea
