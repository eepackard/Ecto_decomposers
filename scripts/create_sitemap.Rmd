...
map1 <- tm_shape(sverige_simp) +
  ...
  tm_dots(col = "host", size = 0.25,shape = 1,palette=c("#2A9D8F","#275651"),title = "National samples",legend.show = FALSE)+
  ...
  tm_add_legend(type = "fill",col = c("#2A9D8F","#275651"),labels = c("Pine dominated", "Spruce dominated"),title = "Large-scale samples")+
  tm_add_legend(type = "fill",col = c("#E9C46A","#F59546"),labels = c("Pine dominated", "Spruce dominated"),title = "Small-scale samples")+
...
map3 <- tm_shape(sverige,bbox = c(xmin=600000,ymin=6603368,xmax=736000,ymax=6750000)) +
  tm_polygons(border.col = "black", col = "white", alpha = 0.1)+ 
  tm_shape(sjoar,bbox = c(xmin=600000,ymin=6603368,xmax=736000,ymax=6750000)) +
  tm_fill(col = "lightblue")+
  tm_shape(data_sf_ss["Species"]) +
  tm_dots(col = "Species", size = 4.0,border.lwd=3,shape = 1,palette=c("#E9C46A","#F59546"),title = "Regional samples",legend.show = FALSE)
...
map4 <- tm_shape(sverige,bbox = c(xmin=600000,ymin=6603368,xmax=736000,ymax=6750000)) +
  ...
  tm_fill(col = "lightblue")+
  tm_shape(data_sf_ss["Species"]) +
  tm_dots(col = "Species", size = 4.0,border.lwd=3,shape = 1,palette=c("navy","dodgerblue"),title = "Regional samples",legend.show = FALSE)
