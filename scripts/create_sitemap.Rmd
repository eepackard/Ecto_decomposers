...
map1 <- tm_shape(sverige_simp) +
  ...
  tm_dots(col = "Species", size = 0.25,shape = 1,palette=c("tomato","darkred"),title = "Regional samples")+
...
map2 <- tm_shape(sverige_simp) +
  ...
  tm_dots(col = "Bestandsalder", size = 0.25,shape = 1,palette="Greens",n = 5, contrast = c(0.36, 1),title = "National samples")+
  tm_shape(data_sf_ss["Age"]) +
  tm_dots(col = "Age", size = 0.25,shape = 1,palette=c("tomato","darkred"),title = "Regional samples")+
  tm_layout(legend.width = 1,legend.outside = TRUE,legend.position = c(-0.15,0.1),frame = FALSE)
