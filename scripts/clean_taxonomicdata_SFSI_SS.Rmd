...
scata6353_tax<-read_delim("../raw_data/all_clusters_scata6353.txt",delim = "\t",col_names = FALSE,show_col_types = FALSE) #it doesnt work to simply use ; as delim
scata6353_tax<-cSplit(scata6353_tax,'X1',sep = ";",type.convert = FALSE)


taxsetlist.SFSI<-list(scata6318_tax,scata6353_tax)
