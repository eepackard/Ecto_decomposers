...
#write CCA scores
```{r}
write.csv(scores(MnP.CCA.1,choices = 1)$species,"../clean_data/MNP.CCA.scores.1.5percrev.csv")
write.csv(scores(MnP.CCA.2,choices = 1)$species,"../clean_data/MNP.CCA.scores.residu.1.5percrev.csv")
```
