...
#or the clusters combined with the SFSI - 1.5, 2, 3 %
SFSI.SS.specraw.2<-read_delim("../raw_data/all_tag_by_cluster_counts6318.txt",delim = ";",col_names = TRUE,trim_ws = FALSE,show_col_types = FALSE)
SFSI.SS.specraw.3<-read_delim("../raw_data/all_tag_by_cluster_counts5689.txt",delim = ";",col_names = TRUE,trim_ws = FALSE,show_col_types = FALSE)
SFSI.SS.specraw.4<-read_delim("../raw_data/all_tag_by_cluster_counts5690.txt",delim = ";",col_names = TRUE,trim_ws = FALSE,show_col_types = FALSE)
...
#only 1.5 percent clustering SFSI
