...
#only 2 percent clustering SFSI
...
```{r}
#need to read in taxonomic data so I filter out only agaricomycetes or only ecm 
...
#make ecto relative abun of sfsi 2%
```{r}
...
#only 2 percent
datasetlist.rel.sfsi.ecm<-datasetlist.ecm.sfsi/rowSums(datasetlist.ecm.sfsi)

datasetlist.rel.sfsi.ecm$JordProvnr<-datasetlist.SFSI[[1]]$tag1
```
...
write_csv(datasetlist.rel.sfsi,"../clean_data/SFSI_data_relabun_2perc.csv")
write_csv(datasetlist.rel.sfsi.ecm,"../clean_data/SFSI_data_relabun_ECM_2perc.csv")
```
