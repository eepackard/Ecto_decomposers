...
#read in data
```{r}
SFSI.soil<-read_delim("raw_data/SFSI_NFI_data_20240828_reduced.csv",delim = ";",show_col_types = FALSE)
...
#temperature range
length(SFSI.soil[which(between(SFSI.soil$Temperatursumma,1000,1425)),]$Temperatursumma) #965 in this range
