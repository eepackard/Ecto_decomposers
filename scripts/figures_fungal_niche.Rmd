...
hsyt.pine.freq<-ggplot(hsyt.freq.pine, aes(x = second_column, y = first_column)) +
  ...
  xlab("")+
  ylab("")+
  annotate("text",x=0.6,y=-0.24,label="81.41 \n max",size=1.5)+
  annotate("text",x=1.5,y=-0.23,label="36.72",size=1.5)+
  annotate("text",x=2.5,y=-0.23,label="34.38",size=1.5)+
  annotate("text",x=3.5,y=-0.23,label="31.42",size=1.5)+
  annotate("text",x=4.5,y=-0.23,label="27.45",size=1.5)+
  annotate("text",x=5.4,y=-0.24,label="16.34 \n min",size=1.5)+
  #scale_y_continuous(limits = c(-0.05,1))+
  coord_cartesian(ylim = c(0,1),clip = "off")+
  theme_classic()+
  theme(text = element_text(size=9))#plot.margin = unit(c(1,1,5,2),"cm")
...
hsyt.spruce.freq<-ggplot(hsyt.freq.spruce, aes(x = second_column, y = first_column)) +
  ...
  xlab("CN")+
  ylab("")+
  annotate("text",x=0.6,y=-0.24,label="63.10 \n max",size=1.5)+
  annotate("text",x=1.5,y=-0.23,label="31.58",size=1.5)+
  annotate("text",x=2.5,y=-0.23,label="29.00",size=1.5)+
  annotate("text",x=3.5,y=-0.23,label="26.33",size=1.5)+
  annotate("text",x=4.5,y=-0.23,label="23.36",size=1.5)+
  annotate("text",x=5.4,y=-0.24,label="13.33 \n min",size=1.5)+
  #scale_y_continuous(limits = c(-0.05,1))+
  coord_cartesian(ylim = c(0,1),clip = "off")+
  theme_classic()+
  theme(text = element_text(size=9))#plot.margin = unit(c(1,1,5,2),"cm")
...
pine.plot+pine.plot.categ+plot_layout(widths = c(4,2))
