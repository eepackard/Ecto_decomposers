...
```{r}
freq.lact.all.pine<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Pine"),which(colnames(sfsi.fungniche) =="p Lactarius_vietus")])/210 
freq.lact.all.spruce<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Spruce"),which(colnames(sfsi.fungniche) =="p Lactarius_vietus")])/210 
...
freq.gaut.all.pine<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Pine"),which(colnames(sfsi.fungniche) =="p Gautieria_monticola")])/210 
freq.gaut.all.spruce<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Spruce"),which(colnames(sfsi.fungniche) =="p Gautieria_monticola")])/210 
...
freq.cortc.all.pine<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Pine"),which(colnames(sfsi.fungniche) =="p Cortinarius_comptulus")])/210 
freq.cortc.all.spruce<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Spruce"),which(colnames(sfsi.fungniche) =="p Cortinarius_comptulus")])/210 
...
freq.corts.all.pine<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Pine"),which(colnames(sfsi.fungniche) =="p Cortinarius_semisanguineus")])/210 
freq.corts.all.spruce<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Spruce"),which(colnames(sfsi.fungniche) =="p Cortinarius_semisanguineus")])/210 
...
freq.hyst.all.pine<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Pine"),which(colnames(sfsi.fungniche) =="p Hysterangium")])/210 
freq.hyst.all.spruce<-sum(sfsi.fungniche[which(sfsi.fungniche$tree_dom == "Spruce"),which(colnames(sfsi.fungniche) =="p Hysterangium")])/210 
...
lact.spr.v.pine.freq+gaut.spr.v.pine.freq+russ.spr.v.pine.freq+hyst.spr.v.pine.freq+corts.spr.v.pine.freq+cortc.spr.v.pine.freq
```
