...
```{r}
sfsi.pine$fertbinned<-as.factor(if_else(between(sfsi.pine$unscaled_CN,15,30.74451),"lowest CN",if_else(between(sfsi.pine$unscaled_CN,30.74451,34.87018),"low CN",if_else(between(sfsi.pine$unscaled_CN,34.87018,39.34489),"mid-CN",if_else(between(sfsi.pine$unscaled_CN,39.34489,45.48287),"high CN",if_else(between(sfsi.pine$unscaled_CN,45.48287,113),"highest CN","miss"))))))

sfsi.spruce$fertbinned<-as.factor(if_else(between(sfsi.spruce$unscaled_CN,12,24.72527),"lowest CN",if_else(between(sfsi.spruce$unscaled_CN,24.72527,28.51971),"low CN",if_else(between(sfsi.spruce$unscaled_CN,28.51971,31.50000),"mid-CN",if_else(between(sfsi.spruce$unscaled_CN,31.50000,35.98689),"high CN",if_else(between(sfsi.spruce$unscaled_CN,35.98689,77),"highest CN","miss"))))))
...
hsyt.spruce.freq<-ggplot(hsyt.freq.spruce, aes(x = second_column, y = first_column)) +
  ...
  xlab("CN")+
  ylab("")+
  annotate("text",x=0.6,y=-0.23,label="76.33",size=3)+
  annotate("text",x=1.5,y=-0.23,label="35.99",size=3)+
  annotate("text",x=2.5,y=-0.23,label="31.50",size=3)+
  annotate("text",x=3.5,y=-0.23,label="28.52",size=3)+
  annotate("text",x=4.5,y=-0.23,label="24.73",size=3)+
...
lact.spr.v.pine.freq<-ggplot(freq.lact.p.v.s, aes(x = species, y = freq.lact.p.v.s)) +
  ...
  xlab("")+
  ylab("Frequency")+
  annotate("text",x=1.5,y=1.0,label="L. vietus",size=4)+
  scale_y_continuous(limits = c(0,1))+
  theme_classic()+
  theme(axis.title=element_text(size = 12))
...
gaut.spr.v.pine.freq<-ggplot(freq.gaut.p.v.s, aes(x = species, y = freq.gaut.p.v.s)) +
  ...
  xlab("")+
  ylab("")+
  annotate("text",x=1.5,y=1.0,label="G. monticola",size=4)+
  scale_y_continuous(limits = c(0,1))+
  theme_classic()+
  theme(axis.title=element_text(size = 12))
...
russ.spr.v.pine.freq<-ggplot(freq.russ.p.v.s, aes(x = species, y = freq.russ.p.v.s)) +
  ...
  xlab("")+
  ylab("")+
  annotate("text",x=1.5,y=1.0,label="R. aquosa",size=4)+
  scale_y_continuous(limits = c(0,1))+
  theme_classic()+
  theme(axis.title=element_text(size = 12))
...
cortc.spr.v.pine.freq<-ggplot(freq.cortc.p.v.s, aes(x = species, y = freq.cortc.p.v.s)) +
  ...
  xlab("Dominant host species")+
  ylab("")+
  annotate("text",x=1.5,y=1.0,label="C. comptulus",size=4)+
  scale_y_continuous(limits = c(0,1))+
  theme_classic()+
  theme(axis.title=element_text(size = 12))
...
corts.spr.v.pine.freq<-ggplot(freq.corts.p.v.s, aes(x = species, y = freq.corts.p.v.s)) +
  ...
  xlab("Dominant host species")+
  ylab("")+
  annotate("text",x=1.5,y=1.0,label="C. semisanguineus sl.",size=4)+
  scale_y_continuous(limits = c(0,1))+
  theme_classic()+
  theme(axis.title=element_text(size = 12))
...
hyst.spr.v.pine.freq<-ggplot(freq.hyst.p.v.s, aes(x = species, y = freq.hyst.p.v.s)) +
  ...
  xlab("Dominant host species")+
  ylab("Frequency")+
  annotate("text",x=1.5,y=1.0,label="H. aff. stoloniferum",size=4)+
  scale_y_continuous(limits = c(0,1))+
  theme_classic()+
  theme(axis.title=element_text(size = 12))
