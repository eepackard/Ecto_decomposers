...
pine.freq+spruce.freq+plot_layout(nrow = 2)
```
...
#tiff("../figures/frequencyplots.tiff",width = 10000,height = 8000,res = 1000)
pine.freq+cort.c.spruce.freq+spruce.freq+hyst.pine.freq+plot_layout(nrow = 2)+plot_annotation(tag_levels = "A")
```
