...
#read in data
```{r}
datasetlist.rel.agar.15<-list(read_csv("../clean_data/SS_data_relabun_agar_15_1.5perc.csv"),read_csv("../clean_data/SS_data_relabun_agar_15_2perc.csv"),read_csv("../clean_data/SS_data_relabun_agar_15_3perc.csv"))
